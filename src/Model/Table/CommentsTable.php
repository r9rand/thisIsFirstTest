 ...
 * @property \App\Model\Table\CommentlvsTable|\Cake\ORM\Association\HasMany $Commentlvs
 *
...
class CommentsTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        /* コメントをAjaxで送信するためにコメントアウトした */
        // $validator
        //     ->integer('lvs_count')
        //     ->requirePresence('lvs_count', 'create')
        //     ->notEmpty('lvs_count');
