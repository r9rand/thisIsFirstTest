...
$this->assign('title', 'タイムラインは為になるなぁ！');
 ?>
<div class="timeline-wrapper container" id="">
  <?php foreach($reports as $report) : ?>
  <div class="report-box card row mb-5">
    <div class="card-body">
      <div class="card-text message-box">
        ...
        <div class="tags-box">
          <?php foreach ($report->tags as $tag) : ?>
            <span class="btn btn-outline-primary tag-box">
              ...
              <span class="tag-body"><?= $this->Html->link(h($tag->body), ['action'=>'search',  '?' => ['tag' => h($tag->body)]]) ?></span>
